function getTaskCategory() {
	var result = [
		['../assets/images/shopping-rafiki.svg', 'Carrying Items'],
		['../assets/images/electrician-rafiki.svg', 'Changing Light Bulbs'],
		['../assets/images/gardening-rafiki.svg', 'Gardening Stuff'],
		['../assets/images/ocd-rafiki.svg', 'Spring Cleaning'],
		['../assets/images/working-rafiki.svg', 'IT Devices Help'],
		['../assets/images/lost-rafiki.svg', 'Go Somewhere'],
		['../assets/images/empty-rafiki.svg', 'Moving Furniture'],
		['../assets/images/cooking-rafiki.svg', 'Cooking Food'],
	];
	return result;
}
...
if (task_category == null) {
	...
	for (let category of task_category) {
		...
		link.href = 'get-location.html?taskname=' + category[1];
		...
		if (
			cat_count % 2 === 0 ||
			category == task_category[task_category.length - 1]
		) {
